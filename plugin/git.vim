...
command! -nargs=* -complete=customlist,ListGitCommits Gd          call GitDiff(<q-args>)
command!          Gst                 call GitStatus()
command! -nargs=? Ga                  call GitAdd(<q-args>)
command! -nargs=* GitLog              call GitLog(<q-args>)
command! -nargs=* Gc                  call GitCommit(<q-args>)
command! -nargs=* Gca                 call GitCommit('--all')
...
command! -nargs=* Gp                  call GitPush(<q-args>)
